...
unsigned long long Quantum::numOfDoubles(int n)
{
    if (logSize > n)
        return 0;
    return 1 << (n - logSize);
...
unsigned long long *Quantum::getMasks(unsigned int i, const unsigned int *k, unsigned int len)
{
    unsigned int l = 1 << i;
...
unsigned int *Quantum::getRanks(unsigned int i, const unsigned int *k)
...
int Quantum::convert(const complexd *A, complexd *B, unsigned int n, unsigned int i, complexd **P, const unsigned int *k, complexd *BUF)
{
...
complexd *Quantum::read(const char *f, int *n)
{
    MPI_File file;
...
void Quantum::write(const char *f, const complexd *A, unsigned int n)
{
    MPI_File file;
...
complexd *Quantum::qubitConvert(const complexd *A, unsigned int n, unsigned int i, complexd **P, const unsigned int *k)
{
    unsigned long long m = numOfDoubles(n);
    if (m == 0)
        throw 3;
...
complexd *Quantum::Hadamard(const complexd *A, unsigned int n, unsigned int k)
{
...
complexd *Quantum::nHadamard(const complexd *A, unsigned int n)
{
    unsigned long long m = numOfDoubles(n);
    if (m == 0)
        throw 3;
...
complexd *Quantum::ROT(const complexd *A, unsigned int n, unsigned int k, double a)
{
    complexd P0[] = {1, 0};
    complexd P1[] = {0, cos(a)};
    P1[1].imag(sin(a));
...
complexd *Quantum::NOT(const complexd *A, unsigned int n, unsigned int k)
{
    complexd P0[] = {0, 1};
    complexd P1[] = {1, 0};
    complexd *P[] = {P0, P1};
...
complexd *Quantum::CNOT(const complexd *A, unsigned int n, unsigned int k1, unsigned int k2)
{
...
complexd *Quantum::CROT(const complexd *A, unsigned int n, unsigned int k1, unsigned int k2, double a)
{
    unsigned int k[] = {k1, k2};
    complexd P0[] = {1, 0, 0, 0};
    complexd P1[] = {0, 1, 0, 0};
